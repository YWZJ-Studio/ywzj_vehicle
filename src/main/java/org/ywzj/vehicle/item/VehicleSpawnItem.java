...
public class VehicleSpawnItem extends Item {
    ...
    public ItemStack getInstance(String vehicleEntityId) {
        ...
        EntityType<?> vehicleType = ForgeRegistries.ENTITY_TYPES.getValue(new ResourceLocation(vehicleEntityId));
        if (vehicleType != null) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        EntityType<?> vehicleType = ForgeRegistries.ENTITY_TYPES.getValue(new ResourceLocation(entityId));
        if (vehicleType != null) {
