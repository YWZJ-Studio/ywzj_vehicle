...
public final class GetJarResources {
    ...
    public static void copyModFile(String srcPath, Path root, String path) {
        URL url = YwzjVehicle.class.getResource(srcPath);
        try {
            if (url != null) {
     ...
     *
     */
    public static void copyModDirectory(String sourcePath, Path targetPath) {
        URL url = YwzjVehicle.class.getResource(sourcePath);
        try {
            if (url != null) {
                copyFolder(url.toURI(), targetPath);
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static InputStream readModFile(String filePath) {
        URL url = YwzjVehicle.class.getResource(filePath);
        try {
            if (url != null) {
