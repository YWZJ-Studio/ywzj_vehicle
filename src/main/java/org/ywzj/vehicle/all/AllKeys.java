...
public class AllKeys {
    ...
    private static final KeyMapping[] ALL_KEYS = {
            ...
            FIRE_CONTROL_LOCK, MAIN_WEAPON_SHOOT, SECONDARY_WEAPON_SHOOT, SECONDARY_WEAPON_SWITCH, MAGNIFICATION_CHANGE, DECOY_FLARE_LAUNCH, SMOKE_GRENADE_LAUNCH, TOGGLE_SEEKER, TOGGLE_WEAPON_BAY,
