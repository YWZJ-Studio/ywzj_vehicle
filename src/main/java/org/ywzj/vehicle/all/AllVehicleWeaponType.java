...
import org.ywzj.vehicle.custom.BaseVehicleWeaponData;
...
public class AllVehicleWeaponType {
    ...
    public static final RegistryObject<VehicleWeaponType<VehicleCannon, BaseVehicleWeaponData>> CANNON = register(
            "cannon", json -> WeaponUnitTypeManager.GSON.fromJson(json, BaseVehicleWeaponData.class), VehicleCannon::new
    );
