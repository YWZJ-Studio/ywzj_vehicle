...
public class VehicleMissileWeaponData extends BaseVehicleWeaponData {
    ...
    @SerializedName("preset_ascent_distance")
    private float presetAscentDistance = 64f;

    @SerializedName("preset_dive_distance")
    private float presetDiveDistance = 128f;
    ...
    public float getPresetAscentDistance() {
        return presetAscentDistance;
    }

    public float getPresetDiveDistance() {
        return presetDiveDistance;
    }
