...
public class MissileEntityRenderer extends EntityRenderer<MissileEntity> {
    ...
    public void render(MissileEntity pEntity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource bufferSource, int pPackedLight) {
        pPoseStack.pushPose();
        {
            ...
            BedrockModel model = BedrockModelLoader.getModel(YwzjVehicle.modLocation("entity/missile_akd10"));
            VertexConsumer builder = bufferSource.getBuffer(RenderType.entityCutout(YwzjVehicle.modLocation("textures/entity/missile_akd10.png")));
